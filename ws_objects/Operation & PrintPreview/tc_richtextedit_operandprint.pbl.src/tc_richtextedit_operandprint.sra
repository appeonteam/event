$PBExportHeader$tc_richtextedit_operandprint.sra
forward
global type tc_richtextedit_operandprint from application
end type
...
global type tc_richtextedit_operandprint from application
string appname = "tc_richtextedit_operandprint"
end type
global tc_richtextedit_operandprint tc_richtextedit_operandprint
...
on tc_richtextedit_operandprint.create
appname="tc_richtextedit_operandprint"
...
on tc_richtextedit_operandprint.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
