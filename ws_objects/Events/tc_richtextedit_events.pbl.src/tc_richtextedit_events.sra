$PBExportHeader$tc_richtextedit_events.sra
forward
global type tc_richtextedit_events from application
end type
...
global type tc_richtextedit_events from application
string appname = "tc_richtextedit_events"
end type
global tc_richtextedit_events tc_richtextedit_events
...
on tc_richtextedit_events.create
appname="tc_richtextedit_events"
...
on tc_richtextedit_events.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
